...
// Use default fallback images to avoid external requests
const defaultBlogImage = '/images/blog-placeholder.jpg';
...
export default function About() {
  ...
  // Simple fallback without complex SVG
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="relative">
                ...
                <div className="relative rounded-2xl shadow-2xl w-full h-80 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 flex items-center justify-center">
                  <div className="text-center text-blue-600 dark:text-blue-400">
                    ...
                    <p className="text-lg font-semibold">ဘားအံ's Blog</p>
                    <p className="text-sm opacity-75">Story & Mission</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-8 shadow-lg max-w-md w-full transform hover:scale-105 transition-transform duration-300">
              <div className="text-center">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="relative w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center border-4 border-white dark:border-gray-800 mx-auto">
                    <span className="text-4xl font-bold text-white">ဘ</span>
                  </div>
                </div>
                ...
                <div className="flex justify-center space-x-4">
                  <a 
                    ...
                    className="p-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-2xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300"
                    aria-label="GitHub"
                  >
